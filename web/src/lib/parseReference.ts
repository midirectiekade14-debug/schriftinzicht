...
const BOOK_ALIASES: Record<string, string> = {
  ...
  mar: 'Markus', mark: 'Markus', markus: 'Markus', marcus: 'Markus',
  luc: 'Lukas', luk: 'Lukas', lukas: 'Lukas', lucas: 'Lukas',
  joh: 'Johannes', johannes: 'Johannes',
  hand: 'Handelingen', handelingen: 'Handelingen', 'handelingen der apostelen': 'Handelingen',
  rom: 'Romeinen', romeinen: 'Romeinen',
  '1kor': '1 Korinthe', '1korinthe': '1 Korinthe', '1korinthiërs': '1 Korinthe',
  '2kor': '2 Korinthe', '2korinthe': '2 Korinthe', '2korinthiërs': '2 Korinthe',
  gal: 'Galaten', galaten: 'Galaten',
  ef: 'Efeze', efeze: 'Efeze', efeziërs: 'Efeze',
  ...
  openb: 'Openbaring', openbaring: 'Openbaring', opb: 'Openbaring', 'openbaring van johannes': 'Openbaring',
};
...
const INLINE_ABBREVS: [RegExp, string][] = [
  ...
  [/\b2\s*Kon\.\s*/gi, '2 Koningen '],
  [/\b1\s*Kron\.\s*/gi, '1 Kronieken '],
  [/\b2\s*Kron\.\s*/gi, '2 Kronieken '],
  [/\bNehem?\.\s*/gi, 'Nehemia '],
  [/\bEst\.\s*/gi, 'Esther '],
  [/\bPsalm?\.\s*/gi, 'Psalmen '],
  [/\bPs\.\s*/gi, 'Psalmen '],
  [/\bSpr\.\s*/gi, 'Spreuken '],
  [/\bPred\.\s*/gi, 'Prediker '],
  [/\bHoogl\.\s*/gi, 'Hooglied '],
  [/\bJesaj?\.\s*/gi, 'Jesaja '],
  [/\bJerem?\.\s*/gi, 'Jeremia '],
  [/\bKlaagl?\.\s*/gi, 'Klaagliederen '],
  [/\bEzech?\.\s*/gi, 'Ezechiël '],
  [/\bDan\.\s*/gi, 'Daniël '],
  [/\bHos\.\s*/gi, 'Hosea '],
  [/\bJoël\.\s*/gi, 'Joël '],
  [/\bAm\.\s*/gi, 'Amos '],
  ...
  [/\bZefan?\.\s*/gi, 'Zefanja '],
  [/\bHagg?\.\s*/gi, 'Haggaï '],
  [/\bZachar?\.\s*/gi, 'Zacharia '],
  [/\bZach\.\s*/gi, 'Zacharia '],
  [/\bMalach?\.\s*/gi, 'Maleachi '],
  [/\bMal\.\s*/gi, 'Maleachi '],
  [/\bMatth?\.\s*/gi, 'Mattheüs '],
  [/\bMark?\.\s*/gi, 'Markus '],
  [/\bLuk?\.\s*/gi, 'Lukas '],
  [/\bJoh\.\s*/gi, 'Johannes '],
  [/\bHand\.\s*/gi, 'Handelingen '],
  [/\bRom\.\s*/gi, 'Romeinen '],
  [/\b1\s*Kor(?:inth(?:e|iërs)?)?\.\s*/gi, '1 Korinthe '],
  [/\b2\s*Kor(?:inth(?:e|iërs)?)?\.\s*/gi, '2 Korinthe '],
  [/\bGalat?\.\s*/gi, 'Galaten '],
  [/\bGal\.\s*/gi, 'Galaten '],
  [/\bEfeze?\.\s*/gi, 'Efeze '],
  [/\bEf\.\s*/gi, 'Efeze '],
  [/\bFilipp?\.\s*/gi, 'Filippenzen '],
  [/\bFil\.\s*/gi, 'Filippenzen '],
  [/\bKol(?:oss)?\.\s*/gi, 'Kolossenzen '],
  [/\b1\s*Thess?\.\s*/gi, '1 Thessalonicenzen '],
  [/\b2\s*Thess?\.\s*/gi, '2 Thessalonicenzen '],
  [/\b1\s*Tim(?:oth)?\.\s*/gi, '1 Timotheüs '],
  [/\b2\s*Tim(?:oth)?\.\s*/gi, '2 Timotheüs '],
  [/\bTit\.\s*/gi, 'Titus '],
  [/\bFilem\.\s*/gi, 'Filemon '],
  [/\bHebr?\.\s*/gi, 'Hebreeën '],
  [/\bJakob?\.\s*/gi, 'Jakobus '],
  [/\bJak\.\s*/gi, 'Jakobus '],
  [/\b1\s*Petr?\.\s*/gi, '1 Petrus '],
  [/\b2\s*Petr?\.\s*/gi, '2 Petrus '],
  [/\b1\s*Joh\.\s*/gi, '1 Johannes '],
  [/\b2\s*Joh\.\s*/gi, '2 Johannes '],
  [/\b3\s*Joh\.\s*/gi, '3 Johannes '],
  [/\bJud\.\s*/gi, 'Judas '],
  [/\bOpenb?\.\s*/gi, 'Openbaring '],
];
