 ...
 * DB stores "Handelingen der apostelen" and "Openbaring van Johannes"
 * but we display "Handelingen" and "Openbaring".
 */
 ...
 * E.g. "Rom. 3:19" → "Romeinen 3:19", "Ef. 3:17" → "Efeziërs 3:17"
 */
const INLINE_ABBREVS: [RegExp, string][] = [
  ...
  [/\bZach\.\s*/gi, 'Zacharia '],
  [/\bMal\.\s*/gi, 'Maleachi '],
  [/\bMatt?h?\.\s*/gi, 'Mattheüs '],
  [/\bMark?\.\s*/gi, 'Marcus '],
  [/\bLuk?\.\s*/gi, 'Lucas '],
  [/\bJoh\.\s*/gi, 'Johannes '],
  [/\bHand\.\s*/gi, 'Handelingen '],
  [/\bRom\.\s*/gi, 'Romeinen '],
  [/\b1\s*Kor\.\s*/gi, '1 Korinthiërs '],
  [/\b2\s*Kor\.\s*/gi, '2 Korinthiërs '],
  [/\bGal\.\s*/gi, 'Galaten '],
  [/\bEf\.\s*/gi, 'Efeziërs '],
  [/\bFil\.\s*/gi, 'Filippenzen '],
  [/\bKol\.\s*/gi, 'Kolossenzen '],
  [/\b1\s*Thess?\.\s*/gi, '1 Thessalonicenzen '],
  [/\b2\s*Thess?\.\s*/gi, '2 Thessalonicenzen '],
  [/\b1\s*Tim\.\s*/gi, '1 Timotheüs '],
  [/\b2\s*Tim\.\s*/gi, '2 Timotheüs '],
  [/\bTit\.\s*/gi, 'Titus '],
  [/\bFilem\.\s*/gi, 'Filemon '],
  [/\bHebr?\.\s*/gi, 'Hebreeën '],
  [/\bJak\.\s*/gi, 'Jakobus '],
...
const BOOK_ORDER = [
  ...
  'Handelingen der apostelen', 'Romeinen',
  '1 Korinthiërs', '2 Korinthiërs', 'Galaten', 'Efeziërs',
